...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCyvvHKG-mifH6LIBKneDnJXHnqlAPpuec&libraries=places"></script>
<script>
function initMap() {
    // Replace 'YOUR_API_KEY' with your actual Google Maps API key
    const apiKey = 'AIzaSyCyvvHKG-mifH6LIBKneDnJXHnqlAPpuec';
    
    // Specify the latitude and longitude of the three locations
    const locations = [
